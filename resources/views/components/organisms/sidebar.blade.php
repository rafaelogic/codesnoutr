...
<div 
    ...
    class="flex flex-col h-full bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-600 transition-all duration-300"
    {{ $attributes }}
>
    <!-- Brand/Header -->
        ...
        <div class="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-600">
            ...
            @if($collapsible)
                <button 
                    ...
                    class="p-1.5 rounded-md text-gray-400 hover:text-gray-600 dark:text-gray-300 dark:hover:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                    <x-atoms.icon 
                        x-show="!collapsed" 
                        name="chevron-left" 
        ...
        @foreach($navigation as $item)
            ...
            @elseif(isset($item['children']))
                ...
                <div x-data="{ open: {{ $item['open'] ?? 'false' }} }">
                    <button
                        @click="open = !open"
                        class="w-full flex items-center justify-between px-3 py-2 text-sm font-medium rounded-md text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700 group focus:outline-none focus:ring-2 focus:ring-blue-500"
                    >
                        ...
                        @foreach($item['children'] as $child)
                            @php
                                ...
                                $childClasses = $isChildActive 
                                    ? 'bg-blue-50 dark:bg-blue-900/30 border-r-2 border-blue-600 text-blue-600 dark:text-blue-300'
