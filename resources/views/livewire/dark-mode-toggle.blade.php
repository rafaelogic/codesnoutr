<div class="flex items-center">
    <button wire:click="toggleDarkMode" 
        ...
        <span wire:loading.remove wire:target="toggleDarkMode"
            ...
            <!-- Sun icon (light mode) -->
            @if(!$darkMode)
            <svg class="absolute inset-0.5 h-4 w-4 text-yellow-500" 
                 fill="currentColor" 
                 viewBox="0 0 20 20">
            ...
            <!-- Moon icon (dark mode) -->
            @if($darkMode)
            <svg class="absolute inset-0.5 h-4 w-4 text-indigo-600" 
                 fill="currentColor" 
                 viewBox="0 0 20 20">
    ...
    mediaQuery.addListener((e) => {
        ...
        if (!localStorage.getItem('codesnoutr-theme')) {
            ...
            if (window.Livewire && window.Livewire.find) {
                ...
                if (component) {
                    component.call('setDarkMode', e.matches);
                }
            }
        }
    });
